...
const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'Да, я работаю в разных городах и странах. Выезд за пределы Санкт-Петербурга обсуждается индивидуально: стоимость транспорта и проживания оплачивается дополнительно.',
  },
  {
